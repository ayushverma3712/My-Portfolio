...
if (!isTouchDevice()) {
    ...
    // Touch device: hide cursor elements and restore normal cursor
...
// ─────────────────────────────────────────────
// PASTE YOUR THREE EMAILJS VALUES BELOW
const EMAILJS_PUBLIC_KEY  = 'yxugjs9UqhMxDGrKQ';      // Account → API Keys
const EMAILJS_SERVICE_ID  = 'service_3i5aco8';      // Email Services → Service ID
const EMAILJS_TEMPLATE_ID = 'template_lhnulq9';     // Email Templates → Template ID
// ─────────────────────────────────────────────
...
const submitBtn   = contactForm.querySelector('.submit-cmd');
...
contactForm.addEventListener('submit', e => {
    ...
    formStatus.textContent = '> Establishing secure channel...';
    ...
    emailjs.sendForm(EMAILJS_SERVICE_ID, EMAILJS_TEMPLATE_ID, contactForm)
        .then(() => {
            ...
            formStatus.textContent = '> SUCCESS: Message delivered to Ayush Verma. _';
        ...
        .catch((error) => {
            ...
            formStatus.style.color = '#f87171';
            formStatus.textContent = '> ERROR: Transmission failed. Try emailing ayushverma3712@gmail.com directly.';
            submitBtn.disabled = false;
            submitBtn.textContent = '[ SEND MESSAGE ]';
        });
});
